...
module Types (F : Cstubs.Types.TYPE) = struct
  ...
  module DeviceDescription_ProcessIndex = struct
    module Args = struct
      type t

      let extension_start, struct_size, size, (t : t structure typ) = pjrt_struct "DeviceDescription_ProcessIndex_Args"
      let device_description = field t "device_description" @@ ptr deviceDescription
  ...
  module DeviceDescription_Attributes = struct
    module Args = struct
      type t
  ...
  module DeviceDescription_Kind = struct
    module Args = struct
      type t
  ...
  module DeviceDescription_DebugString = struct
    module Args = struct
      type t
  ...
  module DeviceDescription_ToString = struct
    module Args = struct
      type t
