  ...
  module TopologyDescription = struct
    ...
    module Create = struct
      module Args = struct
        ...
        let extension_start, struct_size, size, (t : t structure typ) = pjrt_struct "TopologyDescription_Create_Args"
    ...
    module Destroy = struct
      module Args = struct
        ...
        let extension_start, struct_size, size, (t : t structure typ) = pjrt_struct "TopologyDescription_Destroy_Args"
    ...
    module PlatformVersion = struct
      ...
      let api = typedef (static_funptr (ptr Args.t @-> returning error)) @@ _NS "TopologyDescription_PlatformVersion"
    end
    ...
    module Serialize = struct
      module Args = struct
        ...
        let extension_start, struct_size, size, (t : t structure typ) = pjrt_struct "TopologyDescription_Serialize_Args"
        let topology = field t "topology" @@ ptr topologyDescription
